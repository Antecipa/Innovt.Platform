...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="KinesisDataProcessorBatch{TBody}" /> class with optional logging and
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="KinesisDataProcessorBatch{TBody}" /> class with optional batch failure
    ///     reporting.
    /// </summary>
    /// <param name="reportBatchFailures">Specifies whether to report batch processing failures.</param>
